    ...
    <main className="min-h-screen flex items-center justify-center px-5 py-12 bg-cream">
      <div className="w-full max-w-[480px]">
        ...
        <div className="flex border-b border-border mb-6">
          <Link href="/register" className="px-6 py-3 text-[15px] font-medium text-stone border-b-2 border-transparent hover:text-charcoal transition-colors no-underline">
            Đăng ký
          </Link>
